...
class WechatCallbackapi
{
    ...
    private $weixinName;
    private $openid;
    private $echoStr,$signature,$timestamp,$nonce;
    private $token,$appID;
    private $msg_signature;
    private $encrypt_type;
    private $postStr;

    public function __construct($weixinInfo,$weixinGetArr,$postStr)
    {
        ...
        $this->timestamp = $weixinGetArr['timestamp'];
        $this->nonce = $weixinGetArr['nonce'];
        $this->msg_signature = $weixinGetArr['msg_signature'];
        $this->encrypt_type = $weixinGetArr['encrypt_type'];
    ...
    public function responseMsg()
    {
        ...
        $encrypt_type = (isset($this->encrypt_type) && ($this->encrypt_type == 'aes')) ? 'aes' : 'raw';
        ...
        if (!empty($postStr)){
            ...
            if ($encrypt_type == 'aes'){
                ...
                $pc = new \WXBizMsgCrypt($this->token, EncodingAESKey, $this->appID);
                $this->logger(' D \r\n'.$postStr);
                $decryptMsg = '';  //解密后的明文
