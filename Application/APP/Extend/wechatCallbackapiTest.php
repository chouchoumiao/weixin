...
class wechatCallbackapiTest
{
    ...
    private function receiveEvent($object)
    {
        ...
        switch ($object->Event)
        {
            ...
            case 'unsubscribe':
                ...
                $updateWhere2['WEIXIN_ID'] = $weixinID;
            ...
            case 'CLICK':
                ...
                $replyInfoWhwere['WEIXIN_ID'] = $weixinID;
    ...
    private function receiveText($object)
    {
        ...
        //多客服人工回复模式
        $hongbaoWhere['WEIXIN_ID'] = $weixinID;
                ...
                if($hongbaoInfo['hongbao_beginTime'] > $nowTime){
                    ...
                    if(!$hongbaoTimes){
                        ...
                        if($oldTimes >8){
                            ...
                            $hongbaoTimesWhere['subscribe_openid'] = $openid;
                    ...
                    $hongbaoRecordWhere['record_UserOpenid'] = $openid;
                    ...
                    if(!$hongbaoUserRecord){
                        ...
                        $hongbaoRecordInsertData['record_UserOpenid'] = $openid;
